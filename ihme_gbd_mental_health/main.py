...
Usage:
    python -m ihme_gbd_mental_health.main

    python -m ihme_gbd_mental_health.main --skip_download
"""
import click
from ihme_gbd_mental_health import DATASET_DIR, DATASET_NAMESPACE

from ihme_gbd_mental_health import download, clean, match_variables
