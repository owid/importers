...
from ihme_gbd_prevalence import INPATH
...
for i in range(1, 32):
    fname = (
        "https://s3.healthdata.org/gbd-api-2019-public/aaa9739a148f29b5e234b43154512da9_files/IHME-GBD_2019_DATA-aaa9739a-%s.zip"
        % i
    )
    print(fname)
    trycnt = 3
