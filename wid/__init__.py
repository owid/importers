...
DATASET_ADDITIONAL_INFO = "The World Inequality Database aims to provide open and convenient access to an extensive available database on the historical evolution of the world distribution of income and wealth, both within countries and between countries. For further information, please visit the WID website: https://wid.world/"
