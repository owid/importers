...
# Define path to folder containing dataset files.
...
def _save_output_file(summary, output_file, dataset_name, ignore_lucf):
    output_file_parsed = _parse_output_file_name(
        output_file, dataset_name, ignore_lucf=ignore_lucf
    )
...
if __name__ == "__main__":
    ...
    if args.show_in_browser:
        output_file_parsed = _parse_output_file_name(
            args.output_file, args.dataset_name, ignore_lucf=args.ignore_lucf
        )
